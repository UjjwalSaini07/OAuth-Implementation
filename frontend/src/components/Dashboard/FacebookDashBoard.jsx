...
const FacebookDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#0d1117] border border-white/10 rounded-3xl shadow-lg p-8 text-center">
        {userInfo ? (
          <>
            ...
            <p className="text-gray-400 mb-2">
              <span className="font-medium text-white">Facebook ID:</span> {userInfo.facebookId}
            </p>
            {userInfo.email ? (
